...
export default function TradingSettings() {
  ...
  const numericFields = [
    ...
    { key: 'news_blackout_mins',       label: 'News Blackout Window (mins)',  hint: 'Block trades within this many minutes of a HIGH impact news event (e.g. 30)', step: '1', suffix: 'mins' },
  ];
