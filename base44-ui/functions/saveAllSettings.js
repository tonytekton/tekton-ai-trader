...
Deno.serve(async (req) => {
  try {
    ...
    const { auto_trade, friday_flush, risk_pct, target_reward, daily_drawdown_limit, max_session_exposure_pct, max_lots, min_sl_pips, news_blackout_mins } = body;
    ...
    const res = await fetch(`${bridgeUrl}/data/settings`, {
      ...
      body: JSON.stringify({ auto_trade, friday_flush, risk_pct, target_reward, daily_drawdown_limit, max_session_exposure_pct, max_lots, min_sl_pips, news_blackout_mins }),
    });
